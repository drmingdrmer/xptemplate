...
fun! xpt#diff#Diff(a, b) "{{{
    ...
    while end_a <= len_a
        ...
        while end_b <= len_b
            ...
            if char_a == char_b
                ...
                let cur += [ {'longest' : pre.longest + 1,
                      \ 'changes' : { 'a': pre.changes.a + [], 'b': pre.changes.b + [] }
                      \ } ]
            else
                " matrix[end_a - 1, end_b]
                ...
                let cur += [ { 'longest': pre.longest,
                      \ 'changes': { 'a': pre.changes.a + chg_a,
                      \              'b': pre.changes.b + chg_b }
                      \ } ]
            endif
    ...
    return {
          \ 'longest': last.longest + astart + strlen(a:a) - aend,
          \ 'changes': {
          \     'a': ca,
          \     'b': cb,
          \ },
