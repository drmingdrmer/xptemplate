...
fun! xpt#buf#New()
	...
	let b:xptemplateData = { 'filetypes':{}, 'wrapStartPos':0, 'wrap':'', 'savedReg':'', 'snippetToParse':[], 'abbrPrefix':{}, 'fallbacks':[], 'posStack':[], 'stack':[], 'keyword':'\w', 'keywordList':[], 'snipFileScope':{}, 'snipFileScopeStack':[], }
